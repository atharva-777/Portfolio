...
const Navbar = () => {
  ...
  return (
    <header
      ...
      // "
      className="w-full mx-auto px-4 sm:px-20 fixed dark:bg-slate-900/90 bg-white/90 backdrop-blur-md top-0 z-50 shadow border-b border-gray-200 dark:border-gray-700"
    >
